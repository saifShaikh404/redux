...
import { increment, decrement, incrementByAmount, fetchUserById } from '../slice/amountSlice';
  ...
  return (
    <div className="container-amt">
      ...
      <div className="controllers">
        ...
        <button className="btns" onClick={() => dispatch(fetchUserById(4))}>Increment fetch  </button>
      </div>
    </div>
  )
}
